...
2. `docker compose -f /root/app.yaml exec -it gitlab-runner gitlab-runner register`
...
9. 可以通过`docker compose -f /root/app.yaml exec -it gitlab-runner gitlab-runner unregister`取消注册
